      ...
      steps: [
        {
          ...
          fields: [
            { k: "sessions", l: "Monthly Digital Sessions",      d: 5000000, u: "n",  s: "input" },
      ...
      steps: [
        {
          ...
          label: "Value per FTE",
          fields: [
            { k: "ftes", l: "# of FTEs Impacted",          d: 80,      u: "FTEs", s: "input",      n: "Analysts, PMs, marketers, and engineers spending time on manual data work" },
            { k: "pw",   l: "% of Work Impacted",           d: 0.10,    u: "%",    s: "assumption", n: "Forrester TEI 2023: 5–20% of analyst/PM/marketing time on manual data requests" },
            { k: "imp",  l: "Productivity Improvement",     d: 0.80,    u: "%",    s: "assumption", n: "Forrester TEI 2023: 50% reduction in ad-hoc data requests; 80% of that time recaptured" },
            { k: "sal",  l: "Annual Salary + Benefits",     d: 140000,  u: "$",    s: "assumption", n: "Fully-loaded cost including benefits, overhead" },
            { k: "va",   l: "Value Add Rate",               d: 0.60,    u: "%",    s: "assumption", n: "Forrester TEI standard: 60% of recaptured time redirected to higher-value work (vs. meetings, admin)" },
          ],
          fn: (v) => v.sal * v.pw * v.imp * v.va,
          ft: "Salary × % Work Impacted × Improvement × Value Add Rate",
          rl: "Value / FTE",
          ru: "$",
          fin: false,
        },
