...
const THEMES = {
  amplitude: {
    label: "Amplitude",
    bg: "#0f1629", sf: "#1a2340", s2: "#243060",
    bd: "#2e3d6e", accent: "#1677ff", accent2: "#4facfe",
    light: false,
  },
  dark: {
    label: "Dark",
    bg: "#0d0d0d", sf: "#1a1a1a", s2: "#262626",
    bd: "#333333", accent: "#6366f1", accent2: "#a5b4fc",
    light: false,
  },
  neutral: {
    label: "Neutral",
    bg: "#f9fafb", sf: "#ffffff", s2: "#f3f4f6",
    bd: "#e5e7eb", accent: "#3b82f6", accent2: "#1d4ed8",
    light: true,
  },
  warmgrey: {
    label: "Warm Grey",
    bg: "#f5f0eb", sf: "#ffffff", s2: "#ede8e2",
    bd: "#d6cfc7", accent: "#b45309", accent2: "#92400e",
    light: true,
  },
  coolgrey: {
    label: "Cool Grey",
    bg: "#eef2f7", sf: "#ffffff", s2: "#e2e8f0",
    bd: "#cbd5e1", accent: "#475569", accent2: "#1e293b",
    light: true,
  },
  slate: {
    label: "Slate",
    bg: "#1e293b", sf: "#263347", s2: "#2d3f57",
    bd: "#3b4f69", accent: "#38bdf8", accent2: "#7dd3fc",
    light: false,
  },
  sand: {
    label: "Sand",
    bg: "#faf6f0", sf: "#ffffff", s2: "#f2ece3",
    bd: "#ddd4c5", accent: "#c2602a", accent2: "#9c4a1e",
    light: true,
  },
  jcpenney: {
    label: "JCPenney",
    bg: "#1a0000", sf: "#2b0000", s2: "#3d0000",
    bd: "#5c0000", accent: "#cc0000", accent2: "#ff4d4d",
    light: false,
  },
  chase: {
    label: "Chase",
    bg: "#00134d", sf: "#001a66", s2: "#002080",
    bd: "#0033ad", accent: "#117acd", accent2: "#5aabf5",
    light: false,
  },
  disney: {
    label: "Disney",
    bg: "#0d0020", sf: "#150033", s2: "#1e004d",
    bd: "#2e006e", accent: "#9b59f5", accent2: "#c89eff",
    light: false,
  },
  spotify: {
    label: "Spotify",
    bg: "#121212", sf: "#181818", s2: "#212121",
    bd: "#333333", accent: "#1db954", accent2: "#1ed760",
    light: false,
  },
};
